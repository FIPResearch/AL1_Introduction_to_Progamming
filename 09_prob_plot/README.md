...
コード [`09_plot.py`](09_plot.py) は [score_A.csv](https://raw.githubusercontent.com/FIPResearch/AL1_Introduction_to_Progamming/main/09_prob_plot/score_A.csv) を読み込んで点でプロットするものです．
...
コード [`09_plot.py`](09_plot.py) を改良し，ヒストグラムをプロットしましょう．
...
データ [score_A.csv](https://raw.githubusercontent.com/FIPResearch/AL1_Introduction_to_Progamming/main/09_prob_plot/score_A.csv) と [score_B.csv](https://raw.githubusercontent.com/FIPResearch/AL1_Introduction_to_Progamming/main/09_prob_plot/score_B.csv) の平均，分散，標準偏差，中央値，最頻値をそれぞれ計算してみましょう．
それぞれのクラスでの点数の特徴を説明してみましょう．

---
[< 前へ](../08_module) | [トップに戻る](https://github.com/FIPResearch/AL1_Introduction_to_Programming) | [次へ >](../10_statistics) 
