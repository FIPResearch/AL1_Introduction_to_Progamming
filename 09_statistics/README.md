...
コード [`linear_regression.py`](09_linear_regression.py) はみかんの収穫量に対して直線を当てはめて回帰分析を適用した結果です．
...
このコードは1946年～2020年の消費者物価指数のデータ([`bukka.csv`](https://raw.githubusercontent.com/FIPResearch/AL1_Introduction_to_Progamming/main/09_statistics/bukka.csv))に対して多項式回帰を適用したものです．下に，年次ごとに消費者物価指数をプロットしたものを示します．

![消費者物価指数のグラフ](bukka.png)

データは次のURLからダウンロードしてください．  
[>> `bukka.csv`](https://raw.githubusercontent.com/FIPResearch/AL1_Introduction_to_Progamming/main/09_statistics/bukka.csv)  
...
- ラッソ回帰 (`sklearn.linear_model.Lasso()`) *今回は実施しなくても大丈夫です。

> [`bukka.csv`](https://raw.githubusercontent.com/FIPResearch/AL1_Introduction_to_Progamming/main/09_statistics/bukka.csv)は「[持家の帰属家賃を除く総合指数（1947年～最新年）](https://www.e-stat.go.jp/stat-search/files?tclass=000001138366)」（総務省）を加工して作成
